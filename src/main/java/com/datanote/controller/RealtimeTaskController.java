...
import com.datanote.mapper.DnRealtimeTaskMapper;
import com.datanote.model.DnRealtimeTask;
import com.datanote.model.R;
import com.datanote.service.FlinkService;
...
public class RealtimeTaskController {
    ...
    private final DnRealtimeTaskMapper realtimeTaskMapper;
    ...
    public R<List<Map<String, Object>>> list() {
        QueryWrapper<DnRealtimeTask> qw = new QueryWrapper<>();
        qw.orderByDesc("updated_at");
        List<DnRealtimeTask> tasks = realtimeTaskMapper.selectList(qw);
        List<Map<String, Object>> result = new ArrayList<>();
        for (DnRealtimeTask t : tasks) {
    ...
    public R<DnRealtimeTask> detail(@PathVariable Long id) {
        return R.ok(realtimeTaskMapper.selectById(id));
    }

    @PostMapping("/save")
    @Operation(summary = "保存任务")
    public R<Map<String, Object>> save(@RequestBody DnRealtimeTask task) {
    ...
    public R<Map<String, Object>> run(@PathVariable Long id) {
        DnRealtimeTask task = realtimeTaskMapper.selectById(id);
        ...
        try {
            ...
            DnRealtimeTask update = new DnRealtimeTask();
            update.setId(id);
    ...
    public R<Void> start(@PathVariable Long id) {
        DnRealtimeTask task = new DnRealtimeTask();
        task.setId(id);
