<template>
  <div class="datasource-container">
    ...
    <el-table :data="datasources" v-loading="loading" stripe style="width: 100%; margin-top: 16px;">
...
const getTypeTag = (type) => {
  const map = { MySQL: '', Hive: 'warning', PostgreSQL: 'success' }
...
const handleSave = async () => {
  ...
  try {
    await api.post('/datasource/save', form.value)
...
const handleTest = async (row) => {
  try {
    await api.post('/datasource/test', { id: row.id, password: '' })
